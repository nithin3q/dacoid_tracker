...
function SecondPage() {
  ...
  return (
    <>
        ...
        <p className="text-gray-400 mb-24 pb-2">Let’s keep burning to achieve your goals, it hurts only temporarily, if you give up now you will be in pain forever</p>
        <Link to="/signup"><img src={image2} alt="random image" className=" mt-16 ml-72 fixed bottom-0 " /></Link>
    </>
  );
}
